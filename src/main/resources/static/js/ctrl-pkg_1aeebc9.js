    ...
    function r() {
        T.ajax("/wolfman/static/common/images/transparent.gif?t=" + Math.floor(1e6 * Math.random()), {
            success: function (t, o) {
                ...
                }) : ErrorMonitor("web", "succ", "", !0, {xhr: o, type: "succ", url: "/wolfman/static/common/images/transparent.gif"})
            }, error: function (t) {
                ErrorMonitor("web", "req_fail", t.status, !0, {xhr: t, type: "fail", url: "/wolfman/static/common/images/transparent.gif"})
            }
        })
    }

    function e() {
        var t = new Image, o = (new Date).getTime(), n = {timeStart: o};
        t.onerror = function () {
...
define("common:widget/ui/mapTypeTab/mapTypeTab.js", function (require, exports, module) {
    ...
    var streetViewTool = null, panoProxy = {
        $panoCard: null, getPanoCard: function () {
            return this.$panoCard
        }, setPanoCard: function (e) {
            this.$panoCard = e || null
        }
    }, cardNameIndex = {normalMap: 0, satellite: 1, panorama: 2, earth: 1}, MapTypeTab = {
        _currentName: null, init: function (e) {
            ...
            try {
                ...
                baidu(this._container).append(tpl({isSupportEarth: map.isSupportEarth()})), panoProxy.setPanoCard(this._container.find(".mapTypeCard").eq(2))
            } catch (e) {
            ...
            var e, a = this, t = T(".mapTypeCard.normal .switch-box input.switch");
            userMgr.defferd.then(function () {
                ...
                var a = T(e.target), t = T(this).find("input.switch");
...
define("common:widget/ui/loadCtrls/LoadCtrls.js", function (n, o, t) {
    ...
    function i() {
        try {
            ...
            t && t.content && 1 == t.content.code ? ErrorMonitor("load", "loccity_fail", "", void 0, {
                url: "",
                xhr: {startTime: 0, endTime: 0},
                type: "fail"
            }) : ErrorMonitor("load", "succ", "", void 0, {url: "", xhr: {startTime: 0, endTime: 0}, type: "succ"})
        } catch (e) {
    ...
    function d() {
        baidu(".search_box a.mo_dl").on("click", function (o) {
            ...
            T.cookie.set("force", "oldsample", {expires: 6048e5}), addStat("indexheader.searchbox.returnold", "click", {}), location.href = "/"
        })
    }

    function r() {
        n.async("common:widget/ui/Pc2Mobile/Pc2Mobile.js", function () {
        }), n.async("common:widget/ui/MapCenter/MapCenter.js", function (n) {
            n.init()
    ...
    var s = n("common:widget/ui/util/util.js"), u = (n("common:widget/ui/indexUtil/IndexUtil.js"), n("common:widget/ui/stat/CodeStat.js")),
        l = n("common:widget/ui/MapTest/MapTest.js"), m = n("common:widget/com/componentManager.js");
    t.exports = {
        init: function () {
            e(), i(), r(), a(), d(), c()
        }
...
define("common:widget/ui/dataCopyRight/dataCopyRight.js", function (a, t) {
    ...
    a.loadCss({content: i, name: "dataCopyRight"}), t.setCopyRight = function (a) {
        if (!window.isPrint) {
            var t, p = a || e.cityCode, i = map.mapType, s = [o["常州"], o["南昌"], o["乌鲁木齐"], o["无锡"], o["福州"], o["泉州"], o["珠海"], o["贵阳"]],
                r = ([o["北京"], o["上海"], o["广州"], o["深圳"], o["宁波"], o["石家庄"], o["沈阳"], o["长春"], o["青岛"], o["温州"], o["台州"], o["金华"], o["佛山"], o["中山"], o["昆明"], o["南宁"], o["苏州"], o["西安"], o["济南"], o["郑州"], o["合肥"], o["呼和浩特"], o["杭州"], o["成都"], o["武汉"], o["长沙"], o["天津"], o["南京"], o["重庆"], o["大连"], o["东莞"], o["厦门"]], [o["香港特别行政区"]]),
                d = (T.array.indexOf(s, "" + p) > -1, T.array.indexOf(r, "" + p) > -1, p >= 9e3 && 9378 >= p), b = p >= 2e4 && 20499 >= p,
                c = p >= 20500 && 25999 >= p, m = p >= 26e3 && 29999 >= p, l = p >= 3e4 && 30999 >= p, g = p >= 31e3 && 37e3 >= p,
                h = p >= 46609 && 52505 >= p, u = p >= 39509 && 53500 >= p, w = p >= 54e3 && 7e4 >= p,
                f = "&copy; #{0} Baidu - GS(2019)5218号 - 甲测资字1100930 - 京ICP证030173号 ";
            if (t = [f], map.getZoom() <= 9 ? t = [f] : d ? t = [f] : m || l ? t = [f] : b || c ? t = [f] : g ? t = [f] : h ? t = [f] : u ? t = [f] : w && (t = [f]), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://map.baidu.com/zt/client/copyrightPc/index.html">版权信息</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="//www.baidu.com">百度首页</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://map.baidu.com/zt/client/service/index.html">服务条款</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://map.baidu.com/zt/client/privacy/index.html">隐私政策</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" id="copy-right-strong" href="https://map-hz.baidu.com/">商业合作</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://lbsyun.baidu.com">地图开放平台</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://biaozhu.baidu.com/?from=mapbottom">品牌/商户认领</a>'), t.push('&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://help.baidu.com/newadd?prod_id=4&category=6">意见建议</a>'), t.push('&nbsp;&nbsp;&nbsp;<a id="download-app">下载地图客户端</a>'), t.push('&nbsp;&nbsp;&nbsp;<a id="download-app" target="_blank" href="https://ugc.map.baidu.com/ifix/poiproblem/addpoipcpage?business_trigger=76">新增地点</a>'), t.push("&nbsp;&nbsp;&nbsp;<a href=\"javascript:void(0);\" onclick=\"addStat('copyright.jumpebaidu','click'); window.open('https://isite.baidu.com/site/e.baidu.com/4a98a7ec-2715-49b3-b97a-6f87b8617926?refer=134', '_blank');\">百度营销</a>"), !window.copyCtrl) {
                window.copyCtrl = new BMap.CopyrightControl({offset: new BMap.Size(-10, 0)}), map.addControl(window.copyCtrl);
                var i = map.getMapType();
                i === BMAP_SATELLITE_MAP || i === BMAP_EARTH_MAP ? (T("#newuilogo").addClass("white"), window.copyCtrl && window.copyCtrl.addSateMapStyle()) : i === BMAP_NORMAL_MAP && (T("#newuilogo").removeClass("white"), window.copyCtrl && window.copyCtrl.removeSateMapStyle())
            }
            var y = (new Date).getFullYear();
            window.copyCtrl.addCopyright({content: baidu.string.format(t.join(""), [y]), id: 1});
            var C, _ = function () {
                0 === T(".BMap_cpyCtrl").length ? C = setTimeout(function () {
                    _()
...
define("common:widget/ui/changeMap/ChangeMap.js", function (e, a, t) {
    ...
    {
        var o = e("common:widget/ui/config/config.js"), i = e("common:widget/ui/indexUtil/IndexUtil.js");
...
define("common:widget/ui/MapCenter/MapCenter.js", function (t, e, n) {
    ...
    function o() {
        var t = map.getBounds(), e = function (t) {
            return 1e3 * parseInt(t / 1e3)
        };
        return e(t.minX) + "," + e(t.minY) + ";" + e(t.maxX) + "," + e(t.maxY)
    }

    var a = t("common:widget/ui/config/config.js"), s = t("common:widget/ui/Traffic/Traffic.js"),
        r = t("common:widget/ui/Weather/Weather.js"), c = t("common:widget/ui/indexUtil/IndexUtil.js"),
        u = t("common:widget/ui/AQIMgr/AQIMgr.js"), l = a.modelConfig, m = (a.mapConfig, a.urlConfig);
    T.extend(i.prototype, {
        init: function () {
            ...
            if (r.active || l.enableMapMove !== !1) {
                ...
                if (4 >= t) return window.temp.map_level = t, void c.setCurCity({name: "全国", code: "1", type: 0});
                var e = map.getCenter(), n = this.startPoint,
                    i = Math.sqrt((n.lng - e.lng) * (n.lng - e.lng) + (n.lat - e.lat) * (n.lat - e.lat)), a = this;
            ...
            if (t && (r.add(t.weather), u.set(t.aqi, t.current_city, "mapcenter")), 0 != l.enableMapMove) {
                try {
                    {
                        var e = t, n = e.content, i = e.current_city;
                        i.code, i.type
                    }
                    n.sup = i.sup, c.setCurCity(i, {from: "mapcenter"}), null != n.sup_bus && c.setSupBus(n.sup_bus), e.hot_city && window._OLR && (window._OLR.hot_city = e.hot_city)
                } catch (o) {
                }
...
define("common:widget/ui/contextMenu/ContextMenu.js", function (e, t, n) {
    function i(e, t) {
        ...
        if ("route" === n.state) {
            ...
            "bus" === i.index ? l.load("BusTrans", {
                cinfo: {isPos: !0, destFlag: t, point: e},
                record: !1,
                isMainRequest: "no",
                isFromContextMenu: !0
    ...
    function o(e, t) {
        t = t || 0, l.load("BusTrans", {cinfo: {isPos: !0, destFlag: t, point: e}, record: !1, isMainRequest: "no", isFromContextMenu: !0})
    }

    function a(e, t) {
        t = t || 0, l.load("NavTrans", {cinfo: {isPos: !0, destFlag: t, point: e}, record: !1, isMainRequest: "no", isFromContextMenu: !0})
    }

    function r(e, t) {
        t = t || 0, l.load("NavWalk", {cinfo: {isPos: !0, destFlag: t, point: e}, record: !1, isMainRequest: "no", isFromContextMenu: !0})
    }

    function s(e, t) {
        t = t || 0, l.load("NavBike", {cinfo: {isPos: !0, destFlag: t, point: e}, record: !1, isMainRequest: "no", isFromContextMenu: !0})
    }
    ...
    function d() {
        var t = function (e) {
            ...
            listener.trigger("poiinfowin.rightmenu.select"), e.async("common:widget/ui/searchInfoWindow/searchInfoWindow.js", function (e) {
                var n = t, i = e.addRangeSearchCenterPoi(n), o = e.createRangeInfoWnd(n);
                o.addEventListener("close", function () {
                    e.exitRangeSearch(), o.overlay && o.overlay.remove()
                }), o.addEventListener("open", function () {
                    window.GRControll && window.GRControll.setGRequestFlg(1500), x.addEventListener("moveend", function () {
                        setTimeout(function () {
                            if (T.g("rangekw")) try {
                                T.g("rangekw").focus()
                            } catch (e) {
                            }
                        }, 100), x.removeEventListener("moveend", arguments.callee)
                    })
                }), e.openSearchInfoWnd(o, i, {pano: !0, panoPoint: n})
            ...
            window.open("https://ugc.map.baidu.com/ifix/poiproblem/addpoipcpage?" + baidu.url.jsonToQuery(t, encodeURIComponent))
        }, v = u([{text: "<span id='cmitem_start'> 以此为起点</span>", callback: t, width: 90}, {
            ...
            callback: c,
            width: 90
        }, {text: '<span id="cmitem_add"> 添加新地点</span>', callback: l, width: 90}]);
        x.addEventListener("maptypechange", function () {
        ...
        var h = function (e, t) {
            ...
            e.getItem(0 + t) && e.getItem(0 + t).enable(), e.getItem(2 + t) && e.getItem(2 + t).enable(), x.getZoom() < 10 ? e.getItem(3 + t).disable() : e.getItem(3 + t).enable();
            var n = m.getState();
        ...
        return v.addEventListener("open", function (e) {
            ...
            b ? (f.point = e.point, f.pixel = e.pixel, g.closePanoPreview(), i.setText('<span id="cmitem_preview">全景预览</span><span id="cmitem_preview_disable"></span>'), i.disable(), n = 1, w.getStreetBriefByLocation({
                ...
                var o = e.content;
                o ? (i.setText('<span id="cmitem_preview">全景预览</span><span id="cmitem_preview_enable"></span>'), i.enable(), f.panoId = o.id) : i.disable(), h(t, n)
            })) : h(t, n)
        }), v
    }
    ...
    function c(e) {
        ...
        if (b) for (var n = 0, i = t.length; i > n; n++) {
            var o = t[n];
            o.separator ? e.addSeparator(0) : e.addItem(new h.MenuItem(o.text, o.callback || function () {
            }, {width: o.width || 100, id: o.id}), 0)
        }
    }

    function u(e, t, n) {
        var i = new h.ContextMenu({container: t});
        t && t !== x ? i.initialize(x) : x.addContextMenu(i);
        for (var o = 0, a = e.length; a > o; o++) {
            var r = e[o];
            r.separator ? i.addSeparator() : i.addItem(new h.MenuItem(r.text, r.callback || function () {
            }, {width: r.width || 100, id: r.id}))
        }
        return i.setCursor(n), c(i), i
    }

    var l = e("common:widget/com/componentManager.js"), m = e("common:widget/ui/searchBox/searchBox.js"),
        p = e("common:widget/ui/mapUtil/mapUtil.js"), g = e("pano:widget/PanoInterface/PanoInterface.js"),
        w = e("pano:widget/base/service.js"), v = function () {
            var e, t = document.createElement("canvas"), n = !0;
            try {
        ...
        }, f = {}, x = window.map, h = window.BMap, b = v(), I = function () {
            var e = x.container, t = T.dom(e).offset(), n = t.top + f.pixel.y, i = t.left + f.pixel.x;
            g.showPanoPreview({panoId: f.panoId, from: "contextMenu", top: n, left: i});
            var o = function () {
                g.closePanoPreview(), T.un(document.body, "click", o)
            };
            T.on(document.body, "click", o);
            var a = function () {
                g.closePanoPreview(), x.removeEventListener("zoomstart", a)
            };
            x.addEventListener("zoomstart", a);
            var a = function () {
                g.closePanoPreview(), x.removeEventListener("moving", a)
            };
            x.addEventListener("moving", a);
            var r = function () {
                g.closePanoPreview(), x.removeEventListener("oncenterandzoom", r)
            };
            x.addEventListener("oncenterandzoom", r)
        }, P = {
            init: function () {
                var e = d();
                return e
...
define("common:widget/ui/Storage/Storage.js", function (e, t, a) {
    baidu.storage = {}, baidu.storage._isValidKey = function (e) {
        ...
        var e = "_BAIDU.ALL.KEY_", t = function () {
            var e = null;
            ...
            a(t, r), result = o({key: e}), result = result ? {value: result} : {
                key: e,
                value: ""
            ...
            if (result = o({key: e})) {
                result = {value: result};
                for (var t = (result.value || "").split("|"), a = t.length, r = 0; a > r; r++) u({key: t[r]})
            }
        };
        return {getItem: o, setItem: r, removeItem: u, clearAll: l}
        ...
        } else t = baidu.storage.userData.getItem(e), t && (t = {value: t});
...
define("common:widget/ui/searchInfoWindow/searchInfoWindow.js", function (e, i, a) {
    function t(e) {
        ...
        if ("cater" != i.src_name && a && a.homepage && r.push('<div class="url"><a href="' + a.homepage + '" target="_blank" >' + a.homepage + "</a></div>"), a && (a.overall_rating || a.price) && !d && "090300" != e.catId) {
            ...
            if (a.price) {
                var u = parseFloat(a.price), h = place.placeConfig.basicInfoCN[i.src_name], _ = h.price, f = h.priceUnit,
    ...
    function n(e) {
        var i = e.ext, a = this, t = i.detail_info, n = i.src_name || "", o = e.uid, s = e.poiType, r = e.cityCode,
            d = (n.toUpperCase() + "_", {action: "open_iw"}), l = [], c = 0, p = "hotel" == i.src_name && parseInt(t.pc_bookable),
        ...
        if (u && l.push(a.generateCaterBookPrice(e)), t.premium2 && T.isArray(t.premium2) && t.premium2.length && "hotel" != n) {
            ...
            if (c = 1, m.length > 1) for (var w = 0; (_ = m[w]) && "lbc-claim" != _.name; w++) ;
        ...
        if (t.other_opera_num && (l.push(['<p class="link"><span>近期上演' + t.other_opera_num + "个剧目，</span>", "<a onclick=\"place.showDetail('" + o + "', '" + s + "', '" + r + "', '" + i.src_name + "','other_opera','Iw');return false\" href=\"javascript:void(0)\">", "查看演出信息&gt;&gt;", "</a></p>"].join("")), d.other_opera = 1), "090300" != e.categoryId && (t.link = t.link || [])) {
            ...
            for (var C = 0; C < t.link.length; C++) if (t.link && t.link[C].url && "DAODAO" != t.link[C].name.toUpperCase()) {
                var I = t.link[C].name, k = t.link[C].url, x = T.url.getQueryValue(k, "qt"), P = "", R = "",
                    M = {from: "map", category: n.toLowerCase(), fun: I, area: "iw"};
                if (x ? (P = k, R = decodeURIComponent(T.url.getQueryValue(k, "url"))) : (P = "http://map.baidu.com/detail?qt=ur", R = k), "kuxun" == I && (R += "?fromid=Khslmapbaidu-S1168731-T1183261&est=marketing"), "elong" == I) {
                    var B = /^http:\/\/www\.elong\.com.*?(_|-)(\d*)(\.html|\-photos.*|_index_1\.html)$/,
                        O = "http://hotel.elong.com/search/$2", E = "?semid=baidumap";
    ...
    function s(e) {
        var i = e.ext ? e.ext.detail_info : {}, a = [], t = "", n = "";
        switch (e.status) {
            case 1:
            case 2:
            case 4:
    ...
    var r = e("common:widget/com/componentManager.js"), d = e("common:widget/ui/util/util.js"),
        l = e("common:widget/ui/constant/Constant.js"), c = e("common:widget/ui/signMgr/signMgr.js"),
        p = e("common:widget/ui/fav/favMgr.js"), u = e("common:widget/ui/mapUtil/mapUtil.js"),
        h = e("common:widget/ui/indexUtil/IndexUtil.js"), _ = e("common:widget/ui/sms/sms.js"), f = e("common:widget/ui/config/config.js"),
        m = e("pano:widget/PanoInterface/PanoInterface.js"), w = e("common:widget/ui/FilterStatus/FilterStatus.js"), v = f.modelConfig,
        g = f.mapConfig, b = f.urlConfig, S = e("common:widget/search/SearchUrlParam.js"), y = function () {
            var e, i = 0, a = null;
            return function (t, n, o, s, r, d) {
                ...
                if (s) ; else {
                    ...
                    if (t.x < l.left) h = t.x - c.left, _ = c.top - t.y, f = p.height / (l.left - c.left), m(); else {
            ...
            addRangeSearchCenterPoi: function (e, i, a, t) {
                ...
                if (n) {
                    ...
                    }), s = t || 25e5, r = new BMap.Marker(n, {icon: o, zIndexFixed: !0, baseZIndex: s, startAnimation: "marker-raise"});
            ...
            createSearchInfoWnd: function (e, i) {
                ...
                var a = e.title, r = "null" === e.addr ? "" : e.addr, d = e.desc, p = e.blinfo, u = e.tel && e.tel.replace(/(,|;)/gi, ", "),
                    h = e.uid || "", _ = e.poiType || l.POI_TYPE_NORMAL, f = e.hasDetail, m = e.ext, w = e.transUid, g = e.mingpian,
                    S = m && m.pic_info ? m.pic_info : [], y = e.userSign || 0, C = e.fav || 0, I = e.content,
                    k = (e.bizType, window.place ? window.place.placeRe : ""),
                    x = (window.place ? window.place.placeConfig : "", window.place ? !!m && m.src_name : ""), P = "cater" === x,
                    R = e.origin_id && e.origin_id.overview_guid ? e.origin_id.overview_guid : "", M = e.catId, B = "", O = "", E = "",
                    N = this, G = e.pano || 0, A = e.indoor_pano || 0,
                ...
                if (Y += "<span class='susIconSetFlag'></span>", P || f && _ !== l.POI_TYPE_BUSSTOP && _ !== l.POI_TYPE_BUSLINE && _ !== l.POI_TYPE_SUBSTOP && _ !== l.POI_TYPE_SUBLINE || !i.hideDetail && (_ === l.POI_TYPE_BUSLINE || _ === l.POI_TYPE_SUBLINE)) {
                    var q = P ? 20 : 25, H = P ? 9 : 11;
                    L.replace(/[\u0100-\uffff]/g, "##").length > q && (L = L.substring(0, H) + "...");
                    var $ = "";
                    if (k && m && ("biaozhu_data" == m.src_name || k.test(x))) {
                        var J = "详情", z = m.detail_info, V = z && (z.pc_bookable || z.di_review_keyword || z.groupon_num || z.premium_flag);
                ...
                Y += "</p>";
                var K = [], Q = "";
                if ((y || e.iwPoiDisplay) && (Q = 'style="display:none;"'), P) K.push("<div class='cater_poi_conTop'" + Q + ">"), K.push(place.caterPopInner.contentHtml(e, j)), K.push("</div>"); else {
                    ...
                    if (K.push(s(e)), F && m.pic && m.pic.length > 0 && m.pic[0] && K.push("<div style='float:right;width:70px;height:70px;overflow:hidden;display:inline' title='" + a + "'><img border='0' alt='" + a + "' src='" + m.pic[0] + "'/></div>"), F && m.src_name && ("biaozhu_data" == m.src_name && "1" == m.yw_type && S.length > 0 && S[0].minurl || k && k.test(m.src_name) && m.detail_info && m.detail_info.image)) {
                        var ti = "", ni = "", oi = 106, si = 104, ri = 71, di = 69, li = "", ci = "", pi = "ISHOP_INFO_IMG", ui = "";
                    ...
                    } else K.push('<table cellspacing="0" class="table_addr_tel"><tr tid="iw_poi_addr"><th>地址：&nbsp;</th><td>'), K.push(r + "&nbsp;</td></tr>"), O = r, u && (K.push('<tr tid="iw_poi_tel"><th>电话：&nbsp;</th><td>' + u + "</td></tr>"), E = u), K.push("</table>"); else u && (K.push('<table cellspacing="0" class="table_addr_tel">'), r && K.push('<tr tid="iw_poi_addr"><th>地址：&nbsp;</th><td>' + r + "</td></tr>"), K.push('<tr tid="iw_poi_tel"><th>电话：&nbsp;</th><td>' + u + "</td></tr>"), E = u, K.push("</table>"));
                    if (d && K.push("<p>" + d + "</p>"), window.place && m && k.test(m.src_name) && (K.push(t({
                        ...
                        if (m.title_link) for (var mi = 0, wi = m.title_link.length; wi > mi; mi++) Si.push("<a class='ns_link' href='" + m.title_link[mi].link + "' target='_blank' >" + m.title_link[mi].title + "</a>"), mi < m.title_link.length - 1 && Si.push("&nbsp;&nbsp;");
                ...
                if (y || h || i.smp) {
                    ...
                    var yi = "";
                    if (c._USERSHARE || !y) {
                        var Ci = "", Ii = "", ki = "shareBtn_u sharex";
                    ...
                    var xi, Pi = "";
                    if (c._USERFAV) {
                        var Ri = a.replace(/\"/g, "&quot;"), Mi = [];
                        r ? Mi.push(_ == l.POI_TYPE_BUSSTOP || _ == l.POI_TYPE_SUBSTOP ? "车次:" + r + "<br/>" : "地址:" + r + "<br/>") : I && Mi.push(I), u && Mi.push("电话:" + u);
                        var Bi = Mi.join("").replace(/\"/g, "&quot;"), Oi = parseFloat(i.x) + "|" + parseFloat(i.y),
                            Ei = {point: Oi, uid: h, cityCode: j, title: Ri, content: Bi, panoGuid: R}, Ni = /'/g;
                        Ni.test(r) && (r = r.replace(Ni, " "), Bi = Bi.replace(Ni, " ")), y ? (xi = {
                            userSign: y,
                            isfav: C,
                            json: Ei,
                            uid: h
                        }, K.push('<span class="fav" id="JiwFav" data-title="' + Ri + '" data-cont="' + Bi + '" title="加入收藏夹"><b></b></span>')) : (xi = {uid: h}, K.push('<span class="fav" id="JiwFav" data-title="' + Ri + '" data-cont="' + Bi + '" uid="' + h + '" title="加入收藏夹" onclick="addStat(\'poiinfowin.poi.fav\');"><b></b></span>'))
                    }
                ...
                return xi && (Ai.favObj = xi), Ai._config.collisions = [[65, 245], [233, 39], [10, 10], [10, 10]], Ai._ext = {
                    uid: h,
            ...
            createAdInfWindow: function (e, i, a) {
                ...
                return t._config.collisions = [[65, 245], [233, 39], [10, 10], [10, 10]], t._ext = {
            ...
            addBottomTabs: function (e, i, a, t) {
                e = e || {};
                var n = "/wolfman/static/common/images/transparent.gif", o = e.tabIndex, s = ["", "", ""], r = ["none", "none", "none"], d = [];
                ...
                var c = ["酒店", "餐馆", "银行", "医院", "公交站"], p = e.isFromMPC ? 1 : 0, u = e.cityCode || v.cityCode;
                if (a) for (var h = 0, _ = c.length; _ > h; h++) {
                    var f = this.generateSingleLink(c[h], a, "", u, 0 === h, e.x + ", " + e.y, p);
                    d.push(f)
                } else for (var h = 0, _ = c.length; _ > h; h++) {
            ...
            createInfWindow: function (e, i) {
                this.opts = this.opts || {};
                var a = this, t = 345, n = new BMap.InfoWindow(i, {title: e, height: 0, width: t, margin: g.infowinMargin});
            ...
            bindInfoEvents: function () {
                var e = this, i = this.content || {}, a = this.opts || {}, t = (i.title, i.addr),
                    n = (i.desc, i.tel && i.tel.replace(/(,|;)/gi, ", "), i.uid || ""), o = i.poiType || l.POI_TYPE_NORMAL,
                    s = (i.hasDetail, i.ext || {}), r = (i.transUid, i.fav || 0),
                    d = (i.content, i.bizType, a.tabIndex, a.cityCode || v.cityCode), u = "", h = "", f = "", w = a.x + " " + a.y,
                    g = parseFloat(a.x) + "|" + parseFloat(a.y), b = i.userSign || 0,
                    S = i.origin_id && i.origin_id.overview_guid ? i.origin_id.overview_guid : "", C = i.pano || 0, I = i.indoor_pano || 0,
                    k = "undefined" == typeof i.pano_index ? -1 : i.pano_index, x = i.wd || "", P = i.street_id || "",
                    R = s.detail_info && s.detail_info.tag, M = "ktv" === R ? "ktv" : s.src_name;
                T(".BMap_bubble_content").delegate(".head-img img", "click", function () {
                    ...
                    m.showPano({
                        ...
                        searchParam: {uid: i, index: k, addr: t, from: "infownd|poi", wd: x}
                    }), addStat(STAT_CODE.STAT_STREETVIEW, {from: "infownd", catalog: "poi", uid: i}), e.preventDefault()
                }), baidu(".iw_poi_conTop .panoInfoBox").on("click", function (e) {
                    var i = "street";
                    addStat(STAT_CODE.STAT_PANORAMA, {catalog: "poi", from: "infownd", item: i});
                    var t = a.isFromMPC ? P : n;
                    !C && I && (i = "inter", t = n), m.showPano({
                        research: !0,
                        panoType: i,
                        searchParam: {uid: t, index: k, from: "infownd|poi", wd: x}
                    ...
                    addStat(STAT_CODE.STAT_PANORAMA, {catalog: "poi", from: "infownd", item: "inter"});
                    var i = a.isFromMPC ? P : n;
                    m.showPano({
                        research: !0,
                        panoType: "inter",
                        searchParam: {uid: i, index: k, from: "infownd|poi", wd: x}
                    }), e.preventDefault(), s && window.place.placeHookPano(s, "iw")
                    ...
                    MapSignInst.editInfoWnd({type: "button"})
                }), baidu(".userShowCtrl .sign_del").on("click", function () {
                    MapSignInst.deletePoint()
                })), baidu(".userShowCtrl .sharex").on("click", function () {
                    addStat("poiinfowin.share.bubbleshare", "click"), c.goShare({uid: n, cityCode: d, title: u, addr: h, tel: f, point: w})
                }), baidu(".userShowCtrl .fav").on("click", function () {
                    addStat(STAT_CODE.STAT_FAV_IW_BTN);
                    var t = T(this), o = t.offset(), s = t.data("cont"), r = t.data("title");
                    if (t.hasClass("has_fav")) {
                        if (i.sid) p.removeFav(i.sid); else if (n) p.removeFav(n, "uid"); else {
                            var d = {
                        ...
                        if (b || a.smp) {
                            p.addFav(2, {name: r, content: s, x: a.x, y: a.y});
                            var c = T.g("JiwFav");
                            c.className = "has_fav", c.title = "取消收藏"
                        } else p.addFav(1, {uid: n, name: r, x: a.x, y: a.y});
                        listener.trigger("searchInfoWindow.fav", "click", {pos: o}), addStat("newfav.poi.addfrombubble", "click", {})
                    }
                }), baidu(".iw_tool_box .point").on("click", function () {
                    addStat("poiinfowin.toolbar.mark");
                    var e = baidu(this).data("cont"), i = baidu(this).data("title");
                    c("searchPoiSign", {point: g, uid: n, cityCode: d, title: i, content: e, panoGuid: S})
                }), baidu("span.send_telf").on("click", function (e) {
                    addStat("poiinfowin.toolbar.poibubbletomb"), addStat(STAT_CODE.STAT_SHOUJI_SEND, {ct: "iw"}), _.ready(this, n, o, d, "iw", this.hasDetailPage), e.preventDefault()
                    ...
                    var i = e.opts.isFromMPC ? 1 : 0, a = parseInt(baidu(this).data("tab")), t = i ? "rangekw" : "";
                    e.switchInfoWndTab(a, t, !1, !1, !0)
                }), baidu(".iw_cate_form .info_form").on("submit", function (t) {
                    window.addStat("search.nearby.sn_btn", "click");
                    var o = "rangekw", s = null, r = a.cityCode || v.cityCode, d = null, l = a.x, c = a.y, p = a.isFromMPC ? !0 : !1,
                        u = p ? 1 : 0, h = i.userSign;
                    ...
                    var t = (Boolean(baidu(this).data("fst")), ""), o = a.cityCode || v.cityCode, s = a.isFromMPC ? 1 : 0, r = r ? r : 0,
                        d = a.statCode || 0;
            ...
            openSearchInfoWnd: function (i, a, t) {
                if (!window.isPrint) {
                    var n = this, o = i._ext || {};
                    if (o && o.uid) {
                        var s = map.getBounds(), r = Math.min(s.minX, s.maxX), l = Math.max(s.minX, s.maxX), c = Math.min(s.minY, s.maxY),
                            u = Math.max(s.minY, s.maxY), h = "(" + r + "," + c + ";" + l + "," + u + ")",
                            _ = (window.currentComponent && window.currentComponent._className, window.currentComponent && window.currentComponent.curKw || ""),
                            f = {uid: o.uid, wd: _, b: h};
                            ...
                            !function () {
                                if (e) {
                                    ...
                                    n.removeFavHandler = function (i, t) {
                                        for (var n = 0; n < t.length; n++) if (t[n].uid === e.uid) {
            ...
            switchInfoWndTab: function (e, i, a, t, n) {
                var o = [T.G("nav_tab0"), T.G("nav_tab1"), T.G("nav_tab2")], s = [T.G("iw_tab0"), T.G("iw_tab1"), T.G("iw_tab2")];
            ...
            roundSearchByValue: function (e, i, a, t, n, o, s, r, d, l) {
                var c = 1e3;
                if (e) {
                    if (null !== r) var p = 1e3; else var p = window.GRControll ? window.GRControll.GRCircleRadius : c;
                    a && T.G(a) && (p = T.G(a).value);
                    var u = {r: p, c: t, wd: encodeURIComponent(e), nbtp: n, nb_x: o, nb_y: s};
                    if (r) u.spotclick = 1; else for (var h in d) d.hasOwnProperty(h) && (u[h] = encodeURIComponent(d[h]));
            ...
            roundSearch: function (e, i) {
                ...
                var n = "nb" + a + "&uid=" + e, o = 16;
                if (window.GRControll && (window.GRControll.GRCircleRadius = i.r, window.GRControll.isGRCircleShow = !0, window.GRControll.setGRequestFlg(1500), window.GRControll.GRCircleRadius > 1500 && (o = 15), window.GRControll.GRCircleRadius > 2500 && (o = 14)), map.centerAndZoom(new BMap.Point(i.nb_x, i.nb_y), o, {noAnimation: !0}), n.indexOf("b=") < 0) {
                    var s = map.getBounds({margins: [0, 0, 0, g.leftMargin]}), d = Math.min(s.minX, s.maxX), l = Math.max(s.minX, s.maxX),
                        c = Math.min(s.minY, s.maxY), p = Math.max(s.minY, s.maxY);
                    n += "&b=(" + d + "," + c + ";" + l + "," + p + ")"
                }
                var u = window.devicePixelRatio && window.devicePixelRatio > 1 ? 2 : 1, h = "B_NORMAL_MAP" === map.getMapType() ? "pl" : "sl";
                ...
                window.GRControll && (window.GRControll.GRCircleRadius && (n += "&gr_radius=" + window.GRControll.GRCircleRadius), window.GRControll.openedMarker = null), w.active = !1, r.go(n + "&from=webmap", {
                    cinfo: {
                        oc: i.c,
                        isnbSearch: !0
                    }, reserveReturnCard: i.reserveReturnCard, staticExpand: i.reserveReturnCard
                })
            },
            rangeSearchByInput: function (e, i, a, t, n, o, s, r, l) {
                var c = r ? 1 : 0;
                if (T.G(e)) if (T.G(e).value) {
                    var p = o || 1;
            ...
            rangeSearchByValue: function (e, i, a, t, n, o, s, r, d, l, c) {
                if (n = v.cityCode, e) {
                    if (null !== r) var p = 1e3; else var p = window.GRControll.GRCircleRadius;
                    t && T.G(t) && (p = T.G(t).value), i = 1 * i, a = 1 * a, p = 1 * p;
                    var u = i - p, h = a - p, _ = i + p, f = a + p, m = "(" + u + "," + h + ";" + _ + "," + f + ")",
                        w = {ar: m, wd: encodeURIComponent(e), c: n, bdtp: o, nb_x: i, nb_y: a, userSign: l};
                    if (r) w.spotclick = 1; else for (var g in d) d.hasOwnProperty(g) && (w[g] = encodeURIComponent(d[g]));
            ...
            rangeSearch: function (e, i, a) {
                if (e) {
                    ...
                    var o = 16;
                    window.GRControll && (window.GRControll.GRCircleRadius = a, window.GRControll.isGRCircleShow = !0, window.GRControll.setGRequestFlg(1500), window.GRControll.GRCircleRadius > 1500 && (o = 15), window.GRControll.GRCircleRadius > 2500 && (o = 14)), map.centerAndZoom(i, o, {noAnimation: !0});
                    var s = "nb" + t;
                    if (s.indexOf("b=") < 0) {
                        var l = map.getBounds({margins: [0, 0, 0, g.leftMargin]});
                    ...
                    var p = "中心点";
                    if (e.userSign) {
                        for (var u, h = c.mapSign.pointInfo.list, n = 0; u = h[n]; n++) if (u.point == i.lng + "|" + i.lat) {
                            p = u.title;
                            break
                        }
                    } else if (this.rangeSearchCenterMarker) p = this.rangeSearchCenterMarker.getTitle(); else for (var u, _ = map.getOverlays(), n = 0; u = _[n]; n++) {
                    ...
                    m && (s += "&uid=" + m), window.GRControll && window.GRControll.GRCircleRadius && (s += "&gr_radius=" + window.GRControll.GRCircleRadius), w.active = !1, r.go(s + "&r=" + a + "&from=webmap", {
                        cinfo: {
                            ...
                            uid: m,
                            isnbSearch: !0
                        }, reserveReturnCard: e.reserveReturnCard, staticExpand: e.reserveReturnCard
                    })
                }
            },
            getCenterPoiNameCbk: function (e) {
                var i = this, a = map.getInfoWindow();
                if (a) {
                    var t = e.content;
                    if (t && t.address) {
                        var n = t.address;
            ...
            createRangeInfoWnd: function (e) {
                if (e) {
                    ...
                    return u.getGEORevertAddress(e, function (e) {
                        i.getCenterPoiNameCbk(e)
                    }), this.createSearchInfoWnd({title: "未知地点", poiType: 0}, {x: e.lng, y: e.lat, statCode: "", tabIndex: 0})
                }
            },
            ...
            iwNavSubmit: function (e) {
                e = window.event || e;
                var i = "", a = "", t = "sn", n = "en", o = "sc", s = "ec", c = "", p = "", u = {}, _ = {}, f = e.target || e.srcElement,
                    m = "", w = this.iwExt, g = this.iwOpts, b = w.c || v.cityCode, S = "", y = "", C = "dep", I = h.getBusExpTime(), k = 5,
                    x = 0;
                switch (f.id) {
                    case"iw_s_pano_frm":
                ...
                var P = T.g(i), R = T.string.trim(P.value);
                if (P && !/\S+/.test(R)) return P.focus(), void(e.returnValue = !1);
                a = "bt" === a ? "bse" : "nse";
                var M = "pcmappg.routesrach.as" + m, B = w.pt.lng + "," + w.pt.lat, O = w.name || "", E = w.uid || "", N = w.wd2 ? 1 : 0,
                    G = w.wd2 || "", A = R, U = w.poiType === l.POI_TYPE_BUSSTOP || w.poiType === l.POI_TYPE_SUBSTOP ? 0 : 1;
                u = {
                    c: b,
                    da_src: M,
                    poiType: w.poiType,
                    ...
                    cinfo: {
                        ...
                        t: x,
                        isSingle: !0,
                        kwn: {name: O, uid: E, pt: w.pt, poiType: w.poiType}
                    }
                };
                ...
                var j = a + "&" + d.jsonToQuery(u), F = u.poiType;
                r.go(j, _), "start" == m ? "bt" == a || "bse" == a ? (F == l.POI_TYPE_BUSSTOP ? addStat("businfowin.tabexchange.fromhere", null, {da_attr: "bus"}) : F == l.POI_TYPE_SUBSTOP && addStat("subinfowin.tabexchange.fromhere", null, {da_attr: "bus"}), addStat("poiinfowin.tabexchange.fromhere", null, {da_attr: "bus"})) : ("nav" == a || "nse" == a) && (F == l.POI_TYPE_BUSSTOP ? addStat("businfowin.tabexchange.fromhere", null, {da_attr: "driving"}) : F == l.POI_TYPE_SUBSTOP && addStat("subinfowin.tabexchange.fromhere", null, {da_attr: "driving"}), addStat("poiinfowin.tabexchange.fromhere", null, {da_attr: "driving"})) : "end" == m && ("bt" == a || "bse" == a ? (F == l.POI_TYPE_BUSSTOP ? addStat("businfowin.tabexchange.goinghere", null, {da_attr: "bus"}) : F == l.POI_TYPE_SUBSTOP && addStat("subinfowin.tabexchange.goinghere", null, {da_attr: "bus"}), addStat("poiinfowin.tabexchange.goinghere", null, {da_attr: "bus"})) : ("nav" == a || "nse" == a) && (F == l.POI_TYPE_BUSSTOP ? addStat("businfowin.tabexchange.goinghere", null, {da_attr: "driving"}) : F == l.POI_TYPE_SUBSTOP && addStat("subinfowin.tabexchange.goinghere", null, {da_attr: "driving"}), addStat("poiinfowin.tabexchange.goinghere", null, {da_attr: "driving"}))), baidu.event.preventDefault(e)
            },
...
define("common:widget/ui/Pc2Mobile/Pc2Mobile.js", function (e, i, o) {
    var t = (e("common:widget/ui/stat/CodeStat.js"), e("common:widget/ui/util/util.js")), d = {
        box: null, init: function () {
            var e = this;
            this.box = T.dom.create("div", {id: "pc2mobile_cover"}), this._innerFun = function () {
                e.resize()
            ...
            if (this.box) {
                var e = this.box, i = t.getClientSize();
        ...
        popup: null, component: null, open: function (e, i, o) {
            switch (o = o || {}, i) {
                case"城市推广安卓按钮":
            ...
            baidu.dom.remove(e), T.cookie.set("Maptodowntip", "2", {expires: 6048e5})
        }, show: function () {
...
define("common:widget/ui/BannerAds/BannerAds.js", function (n, a, e) {
    ...
    e.exports = {
        init: function () {
            {
                var n = window._OLR ? baidu.json.parse(_OLR.index) || {} : {}, a = n.special && n.special.data, e = a.banner || [];
                a.top || [], a.bottom || []
            }
            e.length > 0 && this.createBanner(e), addStat("indexheader.pcads.pcads", "show")
        }, createBanner: function (n) {
            var a = n.length, e = parseInt(Math.random() * a), i = n[e], r = "", c = "";
            ...
            baidu("#mapBanner a").click(function () {
                addStat("indexheader.pcads.pcads", "click", {da_par: n.title})
            })
        }
    }
});
define("common:widget/ui/earthTools/earthTools.js", function (require, exports, module) {
    ...
    var util = require("common:widget/ui/util/util.js"), EarthClock = require("common:widget/ui/earthTools/earthClock.js"),
        comMgr = require("common:widget/com/componentManager.js"), config = require("common:widget/ui/config/config.js"),
        ...
        initialize: function () {
            try {
                var tpl = [function (_template_object) {
                    ...
                    return fn = null, _template_fun_array.join("")
                }][0], container = this.container = T(tpl()).appendTo(this._map.getContainer());
            ...
            T.jsonp(this._getCountURL, function (o) {
                var e = o.data.click, i = t.formatNum(e);
            ...
            var t = this.container, o = t.find("span"), e = this;
            t.delegate("span", "click", function () {
                var t = T(this), o = e[t.attr("map-on-click")];
            ...
            i.addEventListener("maptypechange", function () {
                ...
                e._isClosing = !1;
                var o = t.timeForSunLight, i = o.hour, a = o.minute, n = new Date;
            ...
            T("#clearMapArea").css("display", "none"), window.poi2RouteSearchName = void 0, comMgr.go("cur&wd=" + encodeURIComponent("全国"), {cinfo: {from: "earth_close"}}, t)
            ...
            if (!this._isClosing && !this._map.getLock()) if (this._earthClockIsOpen) this.stopEarth(); else {
                var t = this;
                t._isClosing = !0, t.closeCurQuery(function () {
                    t.startEarth()
                }), addStat("earth.clock", "click", {da_e_name: "pcmapearth"})
            }
        }, setEarthClockPosition: function () {
            var t = this._clockContainer, o = t.offsetWidth, e = map.getSize(), i = e.width,
            ...
            }), addStat("earth.share", "click", {da_e_name: "pcmapearth"})
        }, likeIt: function () {
            if (0 === this._clickCount) {
                var t = this.formatNum(++this._curCount);
                T("#likeItNum").text(t), T.ajax(this._postCountURL, {method: "post", dataType: "json"});
                var o = T("#likeItTip")[0];
                o.style.display = "block", setTimeout(function () {
                    o.style.top = "-100px", o.style.opacity = 0
                }, 100)
            }
            this._clickCount++, addStat("earth.like", "click", {da_e_name: "pcmapearth"})
        }
    }), module.exports = {
        init: function () {
...
define("common:widget/ui/earthTools/earthClock.js", function (t, i, e) {
    ...
    var a = "#A0ADBF", n = 3, o = 25, r = "#A0ADBF", s = 2, c = 30, l = "rgba(12,13,44,0.51)", d = "#A0ADBF", x = "#A0ADBF", w = 3, _ = 3,
        f = 2, g = 2, u = "#A0ADBF";
    T.extend(h.prototype, {
        drawLine: function (t, i, e, h, a, n, o, r, s, c) {
            ...
            var i = 3, e = l, h = d, a = this._ctxWidth / 2, n = this._ctxHeight / 2, o = this._ctxWidth / 2 - 3;
