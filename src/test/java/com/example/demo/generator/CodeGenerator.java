...
public class CodeGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("zjp");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/publish?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("zjp");
        dsc.setPassword("284758");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.example.demo");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
        ...
        strategy.setEntityTableFieldAnnotationEnable(true); //是否在Entity属性上通过注解完成对数据库字段的映射
